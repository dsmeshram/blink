      ...
      <div className="w-full p-6 bg-white rounded-md shadow-md lg:max-w-xl">
        ...
        <form className="mt-6">
          ...
          <div className="mt-2 text-center">
            <button onClick={(e) => handleClick(e)} className="bg-blue-700 hover:bg-blue-800 w-fit px-4 py-2 tracking-wide text-white transition-colors duration-200 transform focus:outline-none focus:bg-gray-600">
              Sign Up
            </button>
          </div>
        </form>
